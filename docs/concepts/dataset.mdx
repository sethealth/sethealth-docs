...
<div style={{textAlign:"center"}}>
    <img alt="Example dataset" style={{borderRadius:"5px"}} src={useBaseUrl('docs-img/ds.png')} />
</div>
...
<div style={{textAlign:"center"}}>
    <img alt="Create dataset modal" style={{maxWidth:"400px", borderRadius:"5px"}} src={useBaseUrl('docs-img/ds-create-modal.png')} />
</div>

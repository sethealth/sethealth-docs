...
In order to create a bucket, you need to click the button shown below.
...
upload data, but all these methods have an option called `bucketID`. Using this field, you can choose on which bucket data will be uploaded.

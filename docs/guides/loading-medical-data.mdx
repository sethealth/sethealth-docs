...
const handlers = await sethealth.med.loadFromFilesystem()[0];
```
...
<iframe
  src="https://stackblitz.com/edit/load-tomography?devtoolsheight=33&embed=1&file=App.tsx&hideExplorer=1&hideNavigation=1"
  width="100%"
  height="600px"
></iframe>

...
sources needed to download MedHandler and Geometries attached. To see how [check out to the next fragment](../guides/sharing-data#creating-a-workspacestate-from-a-serializableworkspace)
